...
class ChromaDB_VectorStore(CopilotBase):
    ...
    def doc_already_exists(self, id: str) -> bool:
        training_data_df = self.get_training_data().to_json(orient='records')
        docs = json.loads(training_data_df)
        doc_ids = [element['id'] for element in docs]
        if id in doc_ids:
            return True
